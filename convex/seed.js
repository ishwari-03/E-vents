...
Healthy snacks and herbal teas included.`,
  ...
  {
  title: "Unplugged Evenings: Acoustic Music Night",
  description: `Experience a soothing evening with live acoustic performances by emerging indie artists. Sit back, relax, and enjoy soulful melodies under warm ambient lights.`,
  category: "music",
  tags: ["music"],
  city: "Bangalore",
  state: "Karnataka",
  venue: "https://maps.app.goo.gl/4tvsgRBQw5GJZXEw6",
  address: "Indiranagar Social, 37, 80 Feet Rd, Bengaluru, Karnataka 560038",
  capacity: 60,
  ticketType: "paid",
  ticketPrice: 350,
  coverImage:
...
{
  title: "Fitness Bootcamp: Train Like a Pro",
  description: `Kickstart your fitness journey with a high-energy outdoor bootcamp led by certified trainers. Strength, cardio, mobility — it's all in one power-packed session.`,
  category: "sports",
  tags: ["sports"],
  city: "Mumbai",
  state: "Maharashtra",
  venue: "https://maps.app.goo.gl/y7s4j7LmvQpGAVj38",
  address: "Marine Drive Promenade, Mumbai, Maharashtra 400020",
  capacity: 40,
  ticketType: "free",
  coverImage:
    "https://images.unsplash.com/photo-1599058917212-d750089bc07d?w=1080&q=80",
  themeColor: "#2563eb",
},
{
  title: "Creative Art & Watercolor Workshop",
  description: `Learn watercolor techniques, color blending, and brush control in this hands-on art workshop. No experience needed — just your creative spirit.`,
  category: "art",
  tags: ["art"],
  city: "Pune",
  state: "Maharashtra",
  venue: "https://maps.app.goo.gl/T6qonM8FofcK3sfF6",
  address: "Koregaon Park, Lane 5, Pune, Maharashtra 411001",
  capacity: 20,
  ticketType: "paid",
  ticketPrice: 499,
  coverImage:
    "https://images.unsplash.com/photo-1529101091764-c3526daf38fe?w=1080&q=80",
  themeColor: "#dc2626",
},
{
  title: "Startup Growth Summit 2025",
  description: `Hear from founders, investors, and industry leaders as they share insights on scaling startups, fundraising strategies, and building sustainable companies.`,
  category: "business",
  tags: ["business"],
  city: "Delhi",
  state: "Delhi",
  venue: "https://maps.app.goo.gl/k3j3hMY2vWMWC6w99",
  address: "India Habitat Centre, Lodhi Rd, Delhi 110003",
  capacity: 200,
  ticketType: "paid",
  ticketPrice: 999,
  coverImage:
...
{
  title: "Gaming Marathon: LAN Party Night",
  description: `Join gamers from across the city for an overnight LAN session featuring Valorant, CS2, FIFA, and more. Snacks, energy drinks, and pure fun guaranteed!`,
  category: "gaming",
  tags: ["gaming"],
  city: "Hyderabad",
  state: "Telangana",
  venue: "https://maps.app.goo.gl/hPEE1tHf79wL1x7h6",
  address: "Gachibowli Indoor Stadium, Hyderabad 500032",
  capacity: 100,
  ticketType: "paid",
  ticketPrice: 300,
  coverImage:
    "https://images.unsplash.com/photo-1535223289827-42f1e9919769?w=1080&q=80",
  themeColor: "#1e40af",
},
{
  title: "Morning Yoga & Breathwork Session",
  description: `Start your day with a refreshing yoga flow followed by calming breathwork to reduce stress and enhance mental clarity.`,
  category: "wellness",
  tags: ["wellness"],
  city: "Chennai",
  state: "Tamil Nadu",
  venue: "https://maps.app.goo.gl/8dBeb5JqK9vw4Lfo8",
  address: "Besant Nagar Beach, Chennai 600090",
  capacity: 50,
  ticketType: "free",
  coverImage:
    "https://images.unsplash.com/photo-1552196563-55cd4e45efb3?w=1080&q=80",
  themeColor: "#059669",
},
{
  title: "Street Photography Walk",
  description: `Capture the vibrant streets, marketplaces, and people during a guided photography walk. Perfect for beginners and enthusiasts.`,
  category: "photography",
  tags: ["photography"],
  city: "Kolkata",
  state: "West Bengal",
  venue: "https://maps.app.goo.gl/CvFZBW2Zo6XqYfL37",
  address: "College Street, Kolkata, West Bengal 700073",
  capacity: 25,
  ticketType: "free",
  coverImage:
    "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=1080&q=80",
  themeColor: "#b45309",
},
{
  title: "Bollywood Dance Jam",
  description: `A fun-filled dance session with high-energy Bollywood choreography. No experience needed — just bring your enthusiasm!`,
  category: "dance",
  tags: ["dance"],
  city: "Jaipur",
  state: "Rajasthan",
  venue: "https://maps.app.goo.gl/ef4ZDaSBBEw2vXyY7",
  address: "Raja Park, Jaipur, Rajasthan 302004",
  capacity: 35,
  ticketType: "paid",
  ticketPrice: 199,
  coverImage:
    "https://images.unsplash.com/photo-1487194482981-1e48b1a3c100?w=1080&q=80",
  themeColor: "#db2777",
},
{
  title: "Travel Meetup: Exploring Hidden Gems of India",
  description: `Connect with fellow travelers and share stories, itineraries, and hacks for discovering lesser-known destinations across India.`,
  category: "travel",
  tags: ["travel"],
  city: "Ahmedabad",
  state: "Gujarat",
  venue: "https://maps.app.goo.gl/gKUB5kXAW9E4vU8B9",
  address: "Sabarmati Riverfront Park, Ahmedabad 380004",
  capacity: 80,
  ticketType: "free",
  coverImage:
    "https://images.unsplash.com/photo-1565808224224-6f312e322b30?w=1080&q=80",
  themeColor: "#0ea5e9",
},
{
  title: "Stand-Up Comedy Night: Laugh Out Loud",
  description: `A hilarious evening featuring stand-up comics performing fresh, witty acts. Good vibes, great jokes, and endless laughter!`,
  category: "comedy",
  tags: ["comedy"],
  city: "Gurgaon",
  state: "Haryana",
  venue: "https://maps.app.goo.gl/WdnTtPg3mA9wUu2w7",
  address: "DLF CyberHub, Gurgaon, Haryana 122002",
  capacity: 120,
  ticketType: "paid",
  ticketPrice: 499,
  coverImage:
    "https://images.unsplash.com/photo-1521375460544-1a6400f52a09?w=1080&q=80",
  themeColor: "#f59e0b",
},
{
  title: "Hackathon: Code. Build. Innovate.",
  description: `A 12-hour hackathon for developers, designers, and innovators. Bring your ideas to life while networking with tech enthusiasts.`,
  category: "tech",
  tags: ["tech"],
  city: "Bangalore",
  state: "Karnataka",
  venue: "https://maps.app.goo.gl/QsxiPFQt7n5PdidF7",
  address: "WeWork ORR, Bellandur, Bangalore 560103",
  capacity: 90,
  ticketType: "free",
  coverImage:
    "https://unsplash.com/photos/man-using-laptop-in-front-of-brown-chair-ourQHRTE2IM",
  themeColor: "#4f46e5",
},
{
  title: "Women in Tech Networking Night",
  description: `An empowering evening for women professionals and students to connect, mentor, and grow together.`,
  category: "networking",
  tags: ["networking"],
  city: "Mumbai",
  state: "Maharashtra",
  venue: "https://maps.app.goo.gl/Yftn67x292fnbvET8",
  address:
    "Powai Hiranandani Gardens, High Street, Mumbai 400076",
  capacity: 70,
  ticketType: "free",
  coverImage:
    "https://unsplash.com/photos/a-stage-with-a-laptop-and-microphone-in-front-of-a-crowd-UCbMZ0S-w28",
  themeColor: "#ec4899",
}
