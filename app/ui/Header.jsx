...
import { useOnboarding } from "@/hooks/user-onboarding";
import SearchLocationBar from "./search_location_bar";
...
export const Header = () => {
  ...
  const isExplorePage =
    pathname.startsWith("/explore"); // hides on /explore and /explore/[slug]
    ...
    <>
      <nav className="fixed top-0 left-0 right-0 backdrop-blur-3xl z-[1000]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* search&location */}
          <div className="hidden md:flex flex-1 justify-center" suppressHydrationWarning>
            <SearchLocationBar />
          </div>

          <div className="flex items-center gap-4">
            {/* ✔ Hide Explore button when already on Explore */}
