...
export default function EventCard({
  ...
  className={`
    ...
    bg-blue-900/10 backdrop-blur-lg
...
>
        ...
        <CardContent className="p-3 flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-sm mb-1 group-hover:text-blue-900 transition-colors line-clamp-2">
              {event.title}
            </h3>
  ...
  className={`
    overflow-hidden group pt-0
    bg-blue-600/10 backdrop-blur-lg
...
>
      ...
      <CardContent className="space-y-3">
        <div>
          ...
          <h3 className="font-semibold text-lg line-clamp-2 group-hover:text-blue-950 transition-colors">
            {event.title}
          </h3>
        </div>
